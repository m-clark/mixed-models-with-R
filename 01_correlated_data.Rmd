...
Now change the following things, running the model after each change, then summarizing and getting confidence intervals.  For each note specifically at least one thing that changed in the results.

- The random effect variance/sd
- The error variance/sd
- Change Ngroups to 10
- Change NperGroup to 10
