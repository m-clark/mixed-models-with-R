...
Which of the above represent the random effects? Now run the following.
...
1. Change the random effect variance/sd and/or the residual variance/sd and note your new estimate of the ICC, and replot the 
2. Reset the values to the original.  Change Ngroups to 10. What differences do you see in the confidence interval estimates? 
3. Set the Ngroups back to 50. Now Change NperGroup to 10, and note again the CI for the variance components.
