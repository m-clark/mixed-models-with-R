...
Next, we can relax the assumption of equal variances.
...
Yeah.  You'll have to look this up every time you want to do it, or just make your own function that takes the model input.
