...
0. Download the zip file at https://github.com/m-clark/mixed-models-with-R/raw/master/mem_workshop.zip. Be mindful of where you put it.
1. Unzip it. Be mindful of where you put the resulting folder.
2. Open RStudio.
3. File/Open Project and click on the blue icon (`mem_workshop.Rproj`) in the folder you just created.
