...
- Use the (currently) undocumented <span class="func">allFit</span> function. How to do so is noted in the convergence help file.  If the results are very similar you can feel better about them.
