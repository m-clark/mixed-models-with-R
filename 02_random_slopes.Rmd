...
[^posthoc]: Note that this relates to a common question about multiple comparisons.  When using techniques that incorporate shrinkage, this is not a problem.  Adjusting p-values after laying waste to the land with pairwise t-tests is not a viable means of dealing with the situation.