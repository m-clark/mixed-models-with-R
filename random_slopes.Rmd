...
Previously we've looked at random intercepts, but any observation or lower level covariate effect could be allowed to vary by cluster as well.


## Application

Returning to the GPA data, recall the visualization from before.  I've animated it to highlight the differences among students.
...
```{r ranints_vs_separateints_more_npg, echo=FALSE}
set.seed(1234)
Nstudent = 200
NperGroup = 100
...
```{r ranints_vs_separateints_more_re, echo=FALSE}
set.seed(1234)
Nstudent  = 200
NperGroup = 6
N = Nstudent * NperGroup
...
```{r ranints_vs_separateints_less_npg, echo=FALSE}
set.seed(1234)
Nstudent = 200
NperGroup = 3
N = Nstudent * NperGroup
...
```{r ranints_vs_separateints_imbalanced, echo=FALSE}
set.seed(1234)  
Nstudent = 200
NperGroup = 10
N = Nstudent * NperGroup
