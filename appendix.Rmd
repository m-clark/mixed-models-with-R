...
```{r pycheck, echo=T, cache=FALSE}
pycheck = ifelse(grepl('Windows', sessionInfo()$running), 
                 'C:/ProgramData/Anaconda3', 
                 '/Users/micl/opt/anaconda3/bin/python')
```
...
I have [several other docs](http://m-clark.github.io/documents/#mixed-models) on various aspects of mixed models, and post about different aspects about them regularly.
