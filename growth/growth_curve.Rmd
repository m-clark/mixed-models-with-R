...
mixed_up_mixed = lmer(gpa ~ sex + occasion + sex:occasion + (1 + occasion|student), data = gpa)
...
Similarly, if we had a time-varying covariate, average weekly hours spent in the library, it'd look like the following:

```{r timevaryingVar, eval=F}
gpa_mixed = lmer(gpa ~ occasion + lib_hours + (1 + occasion|student), data = gpa)
```
