...
```{r}
# if you need them
# install.packages('ggplot2movies') # data example
# install.packages('tidyverse') # dplyr, ggplot, etc.
# install.packages('modelr')    # model predictions etc.
...
See if Action interacts with budget, or any other aspect of the model or data you want to explore. You can do an interaction between two variables as `a + b + a:b` or `a*b`.
