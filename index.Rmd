...
author:  |
  ...
  https://m-clark.github.io/mixed-models-with-R/<br><br>
  <img src="img/signature-acronym.png" style="width:30%; padding:5px 0; margin:0" alt="University of Michigan: CSCAR"> <br>
  <img src="img/ARC-acronym-signature.png" style="width:21%; padding:5px 0; margin:0" alt="University of Michigan: Advanced Research Computing"> 
date: "`r Sys.Date()`"
...
library(broom); library(pander); library(plotly);  library(tidyverse);
library(kableExtra)
```
